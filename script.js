...
function button() {
  ...
  elem.setAttribute("width", "1440px"); //making the unnecessary ling a little bit longer
  document.body.appendChild(elem);
  button.addEventListener("click", buttonClick); //activate button for clicking and calling the squares
  function buttonClick() {
    ...
    square.addEventListener("dblclick", function () {
      if (square.id % 2 == 0 && square.nextElementSibling === null) {
        alert(
          "There isn't a square to remove after clicked square! Maybe a circle though."
        ); //a fun alert for too much clicking
